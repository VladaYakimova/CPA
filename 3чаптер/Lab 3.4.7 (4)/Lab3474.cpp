// Lab3474.cpp : Defines the entry point for the console application.
//
...
int dayOfYear(Date date) 
{
	...
	{
		dayofyear += monthLength(date.year, i);
	}
	return dayofyear;
}
...
{
	int numofdays = 0; if (d2.year < d1.year)
	{
		return -1;
	}
	...
	numofdays += dayOfYear(d2) - dayOfYear(d1);
